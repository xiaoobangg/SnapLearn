...
| 用户管理 | 用户列表（分页+搜索）、用户详情（学习数据、卡片组、错题记录、打卡统计）、重置密码、角色分配 | P0 |
...
| 文档管理 | Markdown 文档编辑/导入/发布到向量库，支持分类和标签 | P0 |
| 博客系统 | 公开博客页面，非登录用户可浏览已发布文章，支持评论 | P1 |
| 音色管理 | 管理系统音色、导入官方音色库、测试合成、声音复刻 | P1 |
| AI 对话 | 管理端 AI 对话入口，与小程序端方案一致 | P1 |
